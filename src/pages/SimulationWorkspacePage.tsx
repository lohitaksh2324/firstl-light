...
import { ChevronLeft, ChevronRight, CheckCircle, Lock, ExternalLink, PlayCircle, XCircle, Share2, Star } from 'lucide-react';
...
function NotebookWorkspace() {
  return (
    <div className="flex-1 p-4 pb-24 max-w-5xl mx-auto w-full space-y-4">
      ...
      <div className="bg-[#111318] border border-[#F97316] rounded-xl overflow-hidden shadow-[0_0_15px_rgba(249,115,22,0.15)] relative">
        <div className="absolute top-0 left-0 w-full h-[1px] bg-[#F97316] animate-pulse" />
        <div className="flex justify-between items-center px-3 py-2 bg-[rgba(255,255,255,0.02)] border-b border-[#1E2530]">
          <div className="text-xs font-mono-data text-[#F97316]">In [ ]: <span className="text-[#64748B]">— Stage 3 Active</span></div>
          <button className="bg-[#F97316] hover:bg-[#F97316]/90 text-white text-xs px-3 py-1 rounded font-mono-data transition-colors flex items-center gap-1">
        ...
        <div className="pt-2">
          <Editor height="120px" theme="vs-dark" language="python"
            ...
            defaultValue={`# TODO: One-hot encode categorical features\n# Target columns: 'admission_type', 'discharge_to', 'primary_diagnosis_group'\n\n`}
          />
        </div>
        <div className="px-3 py-4 border-t border-[#1E2530] bg-[#0A0C0F] text-center">
          <span className="text-xs text-[#64748B] italic">Click ▶ Run to execute · Powered by Pyodide</span>
        </div>
      </div>
    </div>
  );
